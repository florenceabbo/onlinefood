...
#   getting all fooditems from the subcategory
@food_items.route('/sub_food_categories/<sub_food_category>' , methods=['GET'])
def items_under_a_subcategory(sub_food_category):
    response = FoodItem.query.filter_by(sub_food_category_id=sub_food_category)
    returned_food_items = [
         {
        'name':w.name,
        'price':w.price,
        ...
        'image':w.image,
        'sub_category':w.sub_food_category_id
